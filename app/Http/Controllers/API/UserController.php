...
class UserController extends Controller
{
    ...
    public function viewAllUsers()
    {
        try {
            ...
            $users = User::with('areaManagers', 'branch', 'checkers')->select('id', 'firstname', 'lastname', 'branch_code', 'email', 'username', 'role', 'position', 'contact', 'employee_id', 'branch', 'profile_picture', 'email_verified_at', 'signature', DB::raw('IF(email_verified_at IS NULL, "Not Verified", "Verified") as verification_status'))->where('role', '!=', 'Admin')->get();
