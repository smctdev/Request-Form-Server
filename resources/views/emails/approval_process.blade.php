                                            ...
                                            <tr>
                                                <td class="content-cell"
                                                    ...
                                                    <p
                                                        ...
                                                        This email serves to inform you that there is a <strong>request form
                                                        pending your approval</strong>. Your attention to this matter is
                                                        appreciated, as it is essential for the timely processing of the
                                                        request.</p>
                                                    ...
                                                    <table style="margin-bottom: 60px;">
                                                        ...
                                                        <tr>
                                                            <td>Requested by:</td>
                                                            <td>{{$requesterFirstname}}
                                                                {{$requesterLastname}}</td>
                                                        </tr>
                                                    </table>
                                                    <p
