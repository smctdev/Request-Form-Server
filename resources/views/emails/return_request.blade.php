...
<body
    ...
    <table class="wrapper" width="100%" cellpadding="0" cellspacing="0" role="presentation"
        ...
        <tbody>
            <tr>
                <td align="center"
                    style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; padding: 0 0 60px 0;">
                                            ...
                                            <tr>
                                                <td class="content-cell"
                                                    ...
                                                    <p
                                                        ...
                                                        been <b>{{$status}}</b> by <b>{{$approverFirstname}}
                                                            {{$approverLastname}}</b>.</p>
                                                    ...
                                                    <p
                                                        style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 15px; margin-bottom: 60px; text-align: left;">
                                                        You may submit your request again at your convenience. Thank you
                                                        for your attention to this matter!</p>
                                                    <p
